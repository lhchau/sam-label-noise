...
class CIFAR10Noisy(torchvision.datasets.CIFAR10):
    ...
    def _apply_noise(self):
        ...
        for idx in noisy_indices:
            ...
            new_label = np.random.choice([x for x in range(10) if x != current_label])
...
def get_cifar10(
    ...
    data_train = CIFAR10Noisy(root='./data', train=True, download=True, transform=transform_train, noise_rate=noise)
